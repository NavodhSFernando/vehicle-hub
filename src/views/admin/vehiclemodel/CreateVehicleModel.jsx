                        ...
                        <FormItem>
                            ...
                            <div className="flex flex-col items-start p-6 bg-white rounded-lg pb-6">
                                ...
                                <div className="flex flex-col space-y-1 pt-4">
                                    <FormLabel className="pb-3">Vehicle Model ID</FormLabel>
                                </div>
                                <FormControl>
                                ...
                                <div className="flex flex-col space-y-1 pt-6">
                                    <FormLabel className="pb-3">Seating Capacity</FormLabel>
                                </div>
                                <FormControl>
                                ...
                                <Select>
                                    ...
                                    <SelectContent>
                                        <SelectItem value="001">Petrol</SelectItem>
                                        <SelectItem value="002">Diesel</SelectItem>
                                    </SelectContent>
                                </Select>
                            </div>
