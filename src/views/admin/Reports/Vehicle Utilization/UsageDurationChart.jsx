            ...
            <div className="mt-3 w-full flex-1 text-xs" id="chart-container">
                <ResponsiveContainer width="100%" height="100%">
                    <BarChart
                        ...
                        height={300}
                        data={data}
                        layout="vertical" // Change layout to vertical to swap axes
                        margin={{
                            top: 20,
                            right: 10,
                            left: -20,
                    ...
                    >
                        ...
                        <XAxis type="number" /> // Change XAxis to represent numerical values
                        <YAxis dataKey="vehicleNo" type="category" /> // Change YAxis to represent vehicle numbers
                        <Tooltip />
