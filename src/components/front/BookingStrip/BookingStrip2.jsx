            ...
            <div className="flex items-center justify-center w-[1013px] shadow-lg bg-white rounded-lg">
                <ul className="flex justify-center items-center min-[1300px]:flex-row flex-col gap-5 py-5 min-[1300px]:mr-5">
                    <li className="min-[1350px]:px-4">
                        <Datepicker datepicketrtext="Pick-up Date" value={startDate} onChange={setStartDate} />
                    </li>
                    <li className="min-[1300px]:px-4 border-l-[1px] border-slate-400">
                        <TimePicker timepickertext="Pick-up Time" value={startTime} onChange={setStartTime} />
                    </li>
                    <li className="min-[1300px]:px-4 border-l-[1px] border-slate-400">
                        <Datepicker datepicketrtext="Return Date" value={endDate} onChange={setEndDate} />
                    </li>
                    <li className="min-[1300px]:px-4 border-l-[1px] border-slate-400">
                        <TimePicker timepickertext="Return Time" value={endTime} onChange={setEndTime} />
                    </li>
